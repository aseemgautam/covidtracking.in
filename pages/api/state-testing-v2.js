...
export default async (req, res) => {
	...
	stateDataLatest.forEach(current => {
		...
		result.posRate14 = _.nth(stateData, -14).dailyPositivity7DayMA;
		result.posRate13 = _.nth(stateData, -13).dailyPositivity7DayMA;
		result.posRate11 = _.nth(stateData, -11).dailyPositivity7DayMA;
		result.posRate9 = _.nth(stateData, -9).dailyPositivity7DayMA;
		result.posRate7 = _.nth(stateData, -7).dailyPositivity7DayMA;
		result.posRate5 = _.nth(stateData, -5).dailyPositivity7DayMA;
		result.posRate3 = _.nth(stateData, -3).dailyPositivity7DayMA;
		result.posRate = current.dailyPositivity7DayMA;
